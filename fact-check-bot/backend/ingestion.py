...
class PostCache:
    def __init__(self, cache_file: str = "logs/post_cache.json"):
    ...
    def is_cached(self, normalized_text: str) -> bool:
        return self._key(normalized_text) in self._memory

    def get(self, normalized_text: str) -> Optional[dict]:
        return self._memory.get(self._key(normalized_text))
